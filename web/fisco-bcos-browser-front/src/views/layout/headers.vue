<template>
  <div>
    <div class="nav-sider">
      ...
      <div class="nav-title" @click="routerLink('home')">区块链信息</div>
      <hr class="nav-line" />
      ...
      <div class="nav-content">侵权图片总量</div>
      <!-- <div class="mycontainer">
        <div class="nav-menu" style="float: left;">
          <div
            class="nav-menu-item nav-item"
        ...
        <div class="nav-menu">
          <div class="nav-menu-item nav-item" v-for="item in menu" :key="item.title">
            {{item.title}}
...
<style>
.nav-line{
    margin:0;border:1px solid rgb(95, 94, 109)
}
.nav-content {
  color: rgb(35, 5, 92);
  font-weight: 600;
